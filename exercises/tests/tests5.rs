...
unsafe fn modify_by_address(address: usize) {
    // SAFETY: We're dereferencing a raw pointer created from the address.
    // The safety contract of this function guarantees that the address points
    // to a valid and properly aligned u32 value that can be modified.
    unsafe {
